...
console.log("2. Global Execution Context Created and Pushed to Callstack.")

setTimeout(
  () =>
    console.log(
      "9. I'm added to the Queue and will be processed after the Global Execution Context."
    ),
  0
)
...
function foo() {
  setTimeout(
    () =>
      console.log(
        "10. I'm also added to the Queue. Even though I'm within an invoked function."
      ),
    0
  )
}
...
function bar() {
  console.log("4. Bar Local Execution Context Created and Pushed to Callstack.")
  console.log(
    "5. Bar Local Execution Context Created and Popped from Callstack."
  )
}
...
function baz() {
  ...
  bar()
  console.log("6. Baz Local Execution Context Finished. Popped from Callstack.")
}

baz()

console.log("7. Global Execution Context Finished and Removed From Callstack.")
console.log("8. Callstack is empty. Now it'll process events from the Queue.")
```
